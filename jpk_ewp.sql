...
/* Function that checks if given table exists in current schema */

CREATE OR REPLACE FUNCTION CHECK_IF_TABLE_EXIST(T_NAME IN VARCHAR2)
RETURN NUMBER
AS
...
DECLARE
    IS_TABLE_EXIST NUMBER;
BEGIN
    IS_TABLE_EXIST := CHECK_IF_TABLE_EXIST('ADRES_PODMIOTU');
...
DECLARE
    IS_TABLE_EXIST NUMBER;
BEGIN
    IS_TABLE_EXIST := CHECK_IF_TABLE_EXIST('IDENTYFIKATOR_PODMIOTU');
...
DECLARE
    IS_TABLE_EXIST NUMBER;
BEGIN
    IS_TABLE_EXIST := CHECK_IF_TABLE_EXIST('EWPCTRL');
...
DECLARE
    IS_TABLE_EXIST NUMBER;
BEGIN
    IS_TABLE_EXIST := CHECK_IF_TABLE_EXIST('EWPWIERSZ');
...
DECLARE
    IS_TABLE_EXIST NUMBER;
BEGIN
    IS_TABLE_EXIST := CHECK_IF_TABLE_EXIST('NAGLOWEK');
...
DECLARE
    IS_TABLE_EXIST NUMBER;
BEGIN
    IS_TABLE_EXIST := CHECK_IF_TABLE_EXIST('LOG');
